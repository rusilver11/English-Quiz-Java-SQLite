...
public class PQuiz1 extends AppCompatActivity {
    ...
    String quizData[][] = {
            ...
            {"ipq_twenty", "Twenty", "Twelve", "Teen", "Twenty two"},
            {"ipq_basketball", "Play basketball", "Player", "Basketball", "Trowing"},
            {"ipq_cook", "Cook", "Chiken", "Party", "Dish"},
            {"ipq_grape", "Grape", "Purple", "Chery", "Orange"},
            {"ipq_head", "Head", "Face", "Human", "Circle"},
            {"ipq_lips", "Lips", "Mouth", "Tongue", "Teeth"},
            {"ipq_sing", "Sing", "Shout", "Dance", "Human"},
            {"ipq_sixteen", "Sixteen", "Six", "Nineteen", "Sixty"},
            {"ipq_strawberry", "Strawberry", "Pinaple", "Chery", "Banana"},
            {"ipq_write", "Write", "Reading", "Book", "Human"}
